...
void ofApp::draw(){
  fbo.begin();
    ...
    ofFill();//it serves as a loop and starts with filled color for rectangle
  fbo.end();
  
  ofSetColor(255,255,255);  // always set the color before drawing the fbo, it serves as a filter, only white color will show all colors
  fbo.draw(0,0);
}
