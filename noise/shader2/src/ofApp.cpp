...
void ofApp::draw(){
    ...
    //if you want to pass in a interger value, use setUniform1i.
    ...
    //inside the shader these two value are set inside a vec2 object.
    shader.setUniform2f("mousePos", mx, my);
    
    //color changes from magenta to blue when moving the mouse from left right.
    ...
    shader.setUniform4fv("mouseColor", &mouseColor[0]);// passing the 4 value together
